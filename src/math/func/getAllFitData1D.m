function nameList = getAllFitData1D()
    ...
    %
    % Searches for all MATLAB class files that inherit from :class:`FitData`
    % and have "1D" in their name. Returns their names as a string array.
    % This includes direct subclasses and deeper inheritance levels.
    %
    % :return: Array of 1D FitData class names
    % :rtype: string array
    %
    % **Example:**
    %

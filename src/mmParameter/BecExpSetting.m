    ...
    methods
        ...
        function defineSchema(obj)
            obj.TableColumn = dictionary(...
                ...
                "AdCustomXLabel", "string", ...
                "AdCustomYLabel", "string", ...
                ...
                "KdParameter", "struct",...
                "KapitzaParameter", "struct",...
                "ModulationParameter", "struct"...
                );
            ...
            obj.DefaultValue = dictionary(...
                ...
                "KapitzaParameter", "'"+jsonencode(struct(...
                    "MetricName","StdDev2", ...
                    "NoiseFloor",0, ...
                    "InvertOmegaAxis",true, ...
                    "UseDimensionlessAxes",true ...
                ))+"'",...
                "ModulationParameter", "'"+jsonencode(struct(...
                    "ExpectedFrequencyVar","hw_KPModFreq", ...
                    "CalculatePhase",true, ...
                    "PhaseTarget",180, ...
                    "ScopeName","LatticeScope", ... 
                    "IsConvertVolts",false, ...
                    "VoltUnit","V", ...
                    "VoltMultiplier",[1 1 1 1], ...
                    "VoltOffset",[0 0 0 0], ...
                    "IsChirp",false, ...
                    "ChirpEndFreqVar","" ...
                ))+"'"...
